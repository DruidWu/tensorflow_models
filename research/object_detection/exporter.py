...
def _channel_tensor_input_placeholder(input_shape=None):
    if input_shape is None:
        input_shape = (None, None, None, num_input_channels)
    channel_tensor = tf.placeholder(
        dtype=tf.uint8, shape=input_shape, name='channel_tensor')
    return channel_tensor, channel_tensor
...
input_placeholder_fn_map = {
    'channel_tensor': _channel_tensor_input_placeholder,
...
def _add_output_tensor_nodes(postprocessed_tensors,
  ...
  #outputs['refined_box_encodings_pre_nms']=postprocessed_tensors['refined_box_encodings_pre_nms']
  #outputs['class_predictions_with_background_pre_nms']=postprocessed_tensors['class_predictions_with_background_pre_nms']
...
def _get_outputs_from_inputs(input_tensors, detection_model,
  ...
  #end_point = 'down_sample'
  #with tf.variable_scope(end_point):
  ###inputs = slim.conv2d(inputs, 3, [1, 1],          
  ###stride=1,
  ###padding='SAME',
  ###data_format=None,
  ###rate=1,
