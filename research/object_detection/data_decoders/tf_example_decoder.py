...
class TfExampleDecoder(data_decoder.DataDecoder):
  ...
  def __init__(self,
    ...
    #image_encoded = self.keys_to_features['image/encoded']
    #height = tf.to_int32(slim_example_decoder.Tensor(self.keys_to_features['image/height']))
    #width = tf.to_int32(slim_example_decoder.Tensor(self.keys_to_features['image/width']))
    #channels = tf.to_int32(slim_example_decoder.Tensor(self.keys_to_features['image/channels']))
    #to_shape = tf.cast(tf.stack([height, width, channels], axis=0), tf.int32)
  ...
  def decode(self, tf_example_string_tensor):
    ...
    tensor_dict[fields.InputDataFields.image].set_shape([None, None, num_input_channels])
