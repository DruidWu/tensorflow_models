...
class FasterRCNNMetaArch(model.DetectionModel):
  ...
  def __init__(self,
    ...
    #test
    #self._second_stage_mask_loss = (
    #    losses.BootstrappedSigmoidClassificationLoss(alpha=tf.constant(.5, tf.float32)))
  ...
  def predict(self, preprocessed_inputs, true_image_shapes):
    ...
    prediction_dict['refined_box_encodings_pre_nms']=prediction_dict['refined_box_encodings']
    prediction_dict['class_predictions_with_background_pre_nms']=prediction_dict['class_predictions_with_background']
  ...
  def postprocess(self, prediction_dict, true_image_shapes):
    ...
    if self._number_of_stages == 3:
      ...
      detections_dict['refined_box_encodings_pre_nms']=prediction_dict['refined_box_encodings_pre_nms']
      detections_dict['class_predictions_with_background_pre_nms']=prediction_dict['class_predictions_with_background_pre_nms']
      return detections_dict
